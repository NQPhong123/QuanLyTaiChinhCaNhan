...
public class SearchServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FlexibleDate date = searchData.getDate();
            ...
            List<Income> listIncome = incomes.searchTransactions(userID, categoryID, date, amountRange);
            List<Expense> listExpense = expenses.searchTransactions(userID, categoryID, date, amountRange);
